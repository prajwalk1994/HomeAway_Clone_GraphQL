...
import {getSearchResults} from '../../queries/propertyQuery';
...
class SearchResults extends Component{
  ...
  componentDidMount(){
    ...
    this.props.client.query({
      ...
      this.setState({
        Properties : this.state.Properties.concat(response.data.searchProperties)
      })
    })
  }
  ...
  render(){
    ...
    const renderProperties = currentProperties.map(property => {
      var url = BASE_URL +"/uploads/ryan@office.com/p5bde48705ca294b6db0d8028/2.jpg";
      console.log(url);
      return (
        <tr class="media" onClick={(e) => this.retrieveHouseDetails(e, property.id)}>
      ...
      <div>
        ...
        <form class="form-inline">
          <div class='form-group row'>
            ...
            <div class='col'>
              <button class="btn btn-primary" type='submit' onClick={(e) => this.submitSearchDetails(e)} class='btn btn-primary'> Search </button>
            </div>
          </div>
        </form><br/><hr/><br/>
