...
import {getProperty} from '../../queries/propertyQuery';
import {bookPropertyMutation} from '../../mutations/propertyMutations';
...
class PropertyResults extends Component{
  ...
  componentDidMount() {
    let propertyID = this.props.propertyDetails.currentPropertyID;
  ...
  bookProperty(e,property,startDate,endDate, numberOfGuests){
    ...
    this.props.bookPropertyMutation({
      ...
      alert("Booked Property Successfully");
    ...
    let imgCarousel = [];
      ...
      imgCarousel.push(
        <div class="carousel-item" >
          <img class="d-block w-100 property-img" src={`${BASE_URL}/uploads/ryan@office.com/p5bde48705ca294b6db0d8028/${i}.jpg`} alt={`${i}.jpg`} width="1100" height="500"/>
        </div>
      )
    }
    return(
                ...
                <div id="img-carousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100 property-img" src={`${BASE_URL}/uploads/ryan@office.com/p5bde48705ca294b6db0d8028/1.jpg`} alt="1.jpg" />
                    </div>
                    {imgCarousel}
                    </div>
